...
@section('main-content')
    <div class="content">
        <div class="row">
            <form class="form-horizontal ajaxForm" action="{{ route('level.store') }}" method="post"  >
                {{ csrf_field() }}
                <div class="col-md-12">
                    <!-- About Me Box -->
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" placeholder="请输入等级" name="level" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-2">分值：</label>
                                <div class="col-sm-4">
                                    <input class="form-control" placeholder="请输入分值" name="fen" type="text">
                                </div>
                            </div>
