...
@section('main-content')
    <div class="content">
        <div class="row">
            <form class="form-horizontal ajaxForm" action="{{ route('nav.update',['nav' => $nav->id]) }}" method="post" >
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="col-md-9">
                    <!-- About Me Box -->
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <input class="form-control" placeholder="请输入标题" name="name" type="text" value="{{ $nav->name }}">
                            </div>
                            <div class="form-group">
                                <div id="editormd_id">
                                    <textarea name="markdown" style="display:none;">{{ $nav->markdown }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="url" value="{{ $nav->url }}" type="text">
                                <p class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="sort" value="{{ $nav->sort }}" type="text">
                                <p class="help-block">
                                    <i class="fa fa-info-circle color-info1">
                                    </i>
                            ...
                            <div class="form-group">
                                <section class="typecho-post-option allow-option">
                                    ...
                                    <ul>
                                        <li><input id="allowComment" name="is_comment" type="checkbox" value="1"
                                                   @if($nav->is_comment == 1)
                                                   checked
                                                    @endif
                                            >
                                            <label for="allowComment">允许评论</label></li>
                                        <li><input id="allowPing" name="status" type="checkbox" value="1"
                                                   @if($nav->status == 1)
                                                   checked
                                                    @endif
                                            >
