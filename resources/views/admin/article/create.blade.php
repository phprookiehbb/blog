...
@section('main-content')
    <div class="content">
        <div class="row">
            <form class="form-horizontal ajaxForm" action="{{ route('article.store') }}" method="post" >
                {{ csrf_field() }}
                <div class="col-md-8">
                    <!-- About Me Box -->
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <input class="form-control" placeholder="请输入标题" name="title" type="text">
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="请输入文章简介" name="description" type="text">
                            </div>
                            <div class="form-group">
                                <div id="editormd_id">
                    ...
                    <!-- About Me Box -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" name="source" id="source" value="" name="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">作者：</label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="author" placeholder="转载文章必填，原创可留空" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">关键字：</label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="keywords" placeholder="文章关键字,多个以逗号隔开" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" name="click" value="50" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-sm-12" id="upload">
                                        <a class="file">
                                            <input name="img" id="img_upload" type="hidden">
