        ...
        jQuery.ajax({
            ...
            xhr: function() {
                ...
                myXhr.upload && myXhr.upload.addEventListener("progress", function(a) {
                    a.lengthComputable && (a = a.loaded / a.total, 1 == a ? jQuery(".comment-pic-upload-btn").html('<span style="color: #c50808">\u4e0a\u4f20\u5b8c\u6210\uff0c\u5904\u7406\u4e2d...</span>') : jQuery(".comment-pic-upload-btn").html("\u4e0a\u4f20\u4e2d\uff0c\u8fdb\u5ea6\uff1a" + 100 * a + "%"))
                }, !1);
                return myXhr
            },
            beforeSend: function() {
            ...
            success: function(a) {
                "success" != a.code ? jQuery(".comment-pic-upload-btn").html('<span style="color: #c50808">' + a.msg + "</span>") : (jQuery(".comment-pic-input form")[0].url.value = a.data.url.replace(/http:/g, "https:"), commentExtraPicSubmit(jQuery(".comment-pic-input form")[0]))
            },
            error: function(a) {
                console.log(a);
